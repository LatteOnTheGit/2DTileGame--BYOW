...
public class TERenderer {
    ...
    private static final Font font = new Font("Monaco", Font.TYPE1_FONT, 15);
    /**
...
//        StdDraw.text(0.2 * width, height, "@ : You");
//        StdDraw.text(0.5 * width, 1, "Save and Quit (press q)");
//        StdDraw.show();
        renderFrame(world, "");
    }
    ...
    public void renderFrame(TETile[][] world, String message) {
        ...
        StdDraw.text(0.5 * width, 1, "Save and Quit (press q)");
        StdDraw.text(0.2 * width, 1, "Menu (press m)");
        StdDraw.text(0.5 * width, 2, "You see " + message);
        StdDraw.show();
    }
}
